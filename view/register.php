...
<head>
    ...
    <body class="bg-dark text-light">
        <div class="container d-flex justify-content-center bg-dark" style="min-height: 65vh; margin-top: 80px; align-items: center; display: flex;">
            <div class="card shadow-sm mb-3 bg-secondary text-white" style="width: 420px;">
                <div class="card-body">
                    <h4 class="card-title text-center mb-5 text-white">REGISTER</h4>
